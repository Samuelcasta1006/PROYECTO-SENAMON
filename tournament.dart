...
List<Trainer> assignParticipants() {
  List<Trainer> trainers = [
    Trainer('Ash Ketchum', 'ash.ketchum@pokemon.com', DateTime(1987, 5, 1), 0,
        0, []),
    ...
    Trainer('Cynthia', 'cynthia@pokemonleague.com', DateTime(1985, 7, 24), 0, 0,
        []),
    Trainer(
        'Gary Oak', 'gary.oak@palettotown.com', DateTime(1987, 6, 5), 0, 0, []),
    Trainer('Tracey Sketchit', 'tracey@orangeislands.com',
        DateTime(1988, 3, 12), 0, 0, []),
    ...
    Trainer(
        'Korrina', 'korrina@shaalowcity.com', DateTime(1997, 11, 19), 0, 0, []),
  ];
  ...
  """);
        ...
        print(
            "Los participantes seleccionados por el momento son los siguientes");
    ...
    if (option == 4) {
      if (participantsValidation(participants)) {
        ...
        print(
            "La cantidad de integrantes del torneo es incorrecta, ingrese o elimine entrenadores y vuelva a intentarlo");
      }
    }
  }
}
...
void tournament(
    List<List<Trainer>> trainersTournament, List<Trainer> participants) {
  bool proceed = true;
  while (proceed) {
