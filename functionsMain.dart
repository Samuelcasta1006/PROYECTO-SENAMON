  ...
  do {
    ...
    switch (option) {
      case 1:
        ...
        trainers = [
          Trainer('Ash Ketchum', 'ash.ketchum@pokemon.com',
              DateTime(1987, 5, 1), 0, 0, []),
          Trainer(
              'Misty', 'misty@ceruleangym.com', DateTime(1988, 8, 15), 0, 0, [])
        ];
...
""");
  ...
  print(
      "5. Ingresa la cantidad de vidas que tendrá el Senamon, máximo de vidas 100");
  ...
  Senamon senamon = Senamon(
      name, level, type, weight, health, attack, phase, energy, description);
...
void trainSenamon(Trainer trainer) {
  ...
  if (trainer.getExperienceLevel() >= 200) {
    ...
    print(
        "No se puede entrenar un senamon, necesitas por lo menos 200 de experiencia");
  }
}
