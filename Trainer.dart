...
class Trainer {
  ...
  Trainer(this._name, this._email, this._birthDate, this._experienceLevel,
      this._battleWins, this._senamons);
...
""");
  ...
  ----------------------------------------
    """);
      ...
      switch (option) {
        case 1:
          _senamons[indexSenamon]
              .setHealthPoints(_senamons[indexSenamon].getHealthPoints() + 20);
          print(
              "El senamon: ${_senamons[indexSenamon].getName()} ha quedado con una vida de: ${_senamons[indexSenamon].getHealthPoints()}");
          _experienceLevel -= 20;
        ...
        case 2:
          _senamons[indexSenamon]
              .setAttackPower(_senamons[indexSenamon].getAttackPower() + 20);
          print(
              "El senamon: ${_senamons[indexSenamon].getName()} ha quedado con un daño de: ${_senamons[indexSenamon].getAttackPower()}");
          _experienceLevel -= 20;
          print("Has quedado con una experiencia de: $_experienceLevel");
          finish = true;
          break;
