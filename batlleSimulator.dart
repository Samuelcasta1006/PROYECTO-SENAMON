...
List<Trainer> assignTrainers(List<Trainer> trainers) {
  ...
  for (var i = 0; i < trainers.length; i++) {
    ...
    trainersBattle.add(
        Trainer(name, email, birthDate, experienceLevel, battleWins, senamons));
  }
...
""");
  ...
  indexTrainer = mainBattle(trainersBattle, chosenSenamons, indexTrainer,
      indexTrainerEnemy, segundaFase);
  print("""
-------------------------------------------
          FIN DE LA BATALLA
...
int mainBattle(List<Trainer> trainers, List<Senamon> chosenSenamons,
    int indexTrainer, int indexTrainerEnemy, bool segundaFase) {
  bool finish = false;
...
""");
        chosenSenamons[indexTrainer]
            .attack(segundaFase, chosenSenamons[indexTrainerEnemy]);
...
void changeDeadSenamon(
    Trainer trainer, int indexTrainer, List<Senamon> senamons) {
